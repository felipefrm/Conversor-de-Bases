  ...
  int fracao_para_baseX(double *fracionaria, int b_destino);

  int recupera_inteiro(double n);

  double recupera_fracao(double n);

  int inteiro_para_base10(char num[], int b_origem, int ponto, int num_char[]);

  double fracao_para_base10(char num[], int b_origem, int ponto, int digitos, int num_char[]);
